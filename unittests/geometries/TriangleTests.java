...
class TriangleTests {
    ...
    public void testFindIntersections() {
        // Triangle: in the Z=1 plane (הוזז כדי לא לכלול את (0,0,0))
        ...
        assertEquals(List.of(new Point(2, 2, 1)), result1, "Wrong intersection point");

        // TC02: Ray intersects the plane but outside the triangle (0 points)
        Ray ray2 = new Ray(new Point(4, 4, 2), new Vector(0, 0, -1));
        ...
        Ray ray13 = new Ray(new Point(0.9, 1, 2), new Vector(0, 0, -1));
        ...
        Ray ray31 = new Ray(new Point(2, 2, 2), new Vector(0, 0, -1));
        ...
        Ray ray32 = new Ray(new Point(2, 2, 1), new Vector(0, 0, -1));
